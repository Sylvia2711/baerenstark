...
class CookieBanner extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot = this.attachShadow({mode: 'open'});   //  Vor Veröffentlichung auf closed stellen!! Bei open mit F12 anschaubar
        ...
        <div class="cookie-banner ${bannerState}">
            ...
            <slot name="text"><p>Wir verwenden Cookies weil das so ist .... Auf dieser Website werden Daten wie Cookies gespeichert, um wichtige Funktionen der Website sowie Marketing, Personalisierung und Analyse zu ermöglichen.
              Sie können Ihre Einstellungen jederzeit ändern oder die Standardeinstellungen übernehmen. Sie können dieses Banner schließen, um nur mit essenziellen Cookies fortzufahren.</p></slot>
